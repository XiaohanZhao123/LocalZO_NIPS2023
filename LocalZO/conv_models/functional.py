...
lif_save_dirctory = '/home/zxh/remote/sparse_zo_nips2023/experiments/results/grad_sparsity/resnet_surrogate'
lif_zo_save_dirctory = '/home/zxh/remote/sparse_zo_nips2023/experiments/results/grad_sparsity/resnet_localzo'

layer_idx = 0


def layer_index_reset():
    global layer_idx
    layer_idx = 0


def set_output_dir(surrogata_dir, localzo_dir):
    global lif_save_dirctory, lif_zo_save_dirctory
    lif_save_dirctory = surrogata_dir
    lif_zo_save_dirctory = localzo_dir
